...
#   -check times (weird differences that have 141 times vs 144) DONE??
...
ax10.set_xticks([])
ax10.plot(dtime10, dlv0rate10, lw=1, c='green')
ax10.set_title(ULL, fontsize=6)
lp_time_counter10, = ax10.plot([], [], lw=1, c='blue')
lp_TGF_0_10 = ax10.plot([TGF_fixed_time[0], TGF_fixed_time[0]],[700,760],lw=1, c='orange', alpha=.5)
lp_TGF_1_10 = ax10.plot([TGF_fixed_time[1], TGF_fixed_time[1]],[700,760],lw=1, c='orange', alpha=.5)
lp_TGF_2_10 = ax10.plot([TGF_fixed_time[2], TGF_fixed_time[2]],[700,760],lw=1, c='orange', alpha=.5)

ax11 = fig.add_subplot(gs2[0,1])
ax11.set_xlim(int(early_time/10000) + (int(early_time/100) % 100) / 60 + ((early_time % 100) / 360), int(late_time/10000) + (int(late_time/100) % 100) / 60 + ((late_time % 100) / 360))
ax11.set_ylim(700,760)
ax11.set_xticks([])
ax11.set_yticks([])
ax11.plot(dtime11, dlv0rate11, lw=1, c='green')
ax11.set_title(UL, fontsize=6)
lp_time_counter11, = ax11.plot([], [], lw=1, c='blue')
lp_TGF_0_11 = ax11.plot([TGF_fixed_time[0], TGF_fixed_time[0]],[700,760],lw=1, c='orange', alpha=.5)
lp_TGF_1_11 = ax11.plot([TGF_fixed_time[1], TGF_fixed_time[1]],[700,760],lw=1, c='orange', alpha=.5)
lp_TGF_2_11 = ax11.plot([TGF_fixed_time[2], TGF_fixed_time[2]],[700,760],lw=1, c='orange', alpha=.5)

ax12 = fig.add_subplot(gs2[0,2])
ax12.set_xlim(int(early_time/10000) + (int(early_time/100) % 100) / 60 + ((early_time % 100) / 360), int(late_time/10000) + (int(late_time/100) % 100) / 60 + ((late_time % 100) / 360))
ax12.set_ylim(700,760)
ax12.set_xticks([])
ax12.set_yticks([])
ax12.plot(dtime12, dlv0rate12, lw=1, c='green')
ax12.set_title(UM, fontsize=6)
lp_time_counter12, = ax12.plot([], [], lw=1, c='blue')
lp_TGF_0_12 = ax12.plot([TGF_fixed_time[0], TGF_fixed_time[0]],[700,760],lw=1, c='orange', alpha=.5)
lp_TGF_1_12 = ax12.plot([TGF_fixed_time[1], TGF_fixed_time[1]],[700,760],lw=1, c='orange', alpha=.5)
lp_TGF_2_12 = ax12.plot([TGF_fixed_time[2], TGF_fixed_time[2]],[700,760],lw=1, c='orange', alpha=.5)

ax13 = fig.add_subplot(gs2[0,3])
ax13.set_xlim(int(early_time/10000) + (int(early_time/100) % 100) / 60 + ((early_time % 100) / 360), int(late_time/10000) + (int(late_time/100) % 100) / 60 + ((late_time % 100) / 360))
ax13.set_ylim(700,760)
ax13.set_xticks([])
ax13.set_yticks([])
ax13.plot(dtime13, dlv0rate13, lw=1, c='green')
ax13.set_title(UR, fontsize=6)
lp_time_counter13, = ax13.plot([], [], lw=1, c='blue')
lp_TGF_0_13 = ax13.plot([TGF_fixed_time[0], TGF_fixed_time[0]],[700,760],lw=1, c='orange', alpha=.5)
lp_TGF_1_13 = ax13.plot([TGF_fixed_time[1], TGF_fixed_time[1]],[700,760],lw=1, c='orange', alpha=.5)
lp_TGF_2_13 = ax13.plot([TGF_fixed_time[2], TGF_fixed_time[2]],[700,760],lw=1, c='orange', alpha=.5)

ax14 = fig.add_subplot(gs2[0,4])
ax14.set_xlim(int(early_time/10000) + (int(early_time/100) % 100) / 60 + ((early_time % 100) / 360), int(late_time/10000) + (int(late_time/100) % 100) / 60 + ((late_time % 100) / 360))
ax14.set_ylim(700,760)
ax14.set_xticks([])
ax14.set_yticks([])
ax14.plot(dtime14, dlv0rate14, lw=1, c='green')
ax14.set_title(URR, fontsize=6)
lp_time_counter14, = ax14.plot([], [], lw=1, c='blue')
lp_TGF_0_14 = ax14.plot([TGF_fixed_time[0], TGF_fixed_time[0]],[700,760],lw=1, c='orange', alpha=.5)
lp_TGF_1_14 = ax14.plot([TGF_fixed_time[1], TGF_fixed_time[1]],[700,760],lw=1, c='orange', alpha=.5)
lp_TGF_2_14 = ax14.plot([TGF_fixed_time[2], TGF_fixed_time[2]],[700,760],lw=1, c='orange', alpha=.5)

ax15 = fig.add_subplot(gs2[1,0])
ax15.set_xlim(int(early_time/10000) + (int(early_time/100) % 100) / 60 + ((early_time % 100) / 360), int(late_time/10000) + (int(late_time/100) % 100) / 60 + ((late_time % 100) / 360))
ax15.set_ylim(700,760)
ax15.set_xticks([])
ax15.plot(dtime15, dlv0rate15, lw=1, c='green')
ax15.set_title(TLL, fontsize=6)
lp_time_counter15, = ax15.plot([], [], lw=1, c='blue')
lp_TGF_0_15 = ax15.plot([TGF_fixed_time[0], TGF_fixed_time[0]],[700,760],lw=1, c='orange', alpha=.5)
lp_TGF_1_15 = ax15.plot([TGF_fixed_time[1], TGF_fixed_time[1]],[700,760],lw=1, c='orange', alpha=.5)
lp_TGF_2_15 = ax15.plot([TGF_fixed_time[2], TGF_fixed_time[2]],[700,760],lw=1, c='orange', alpha=.5)

ax16 = fig.add_subplot(gs2[1,4])
ax16.set_xlim(int(early_time/10000) + (int(early_time/100) % 100) / 60 + ((early_time % 100) / 360), int(late_time/10000) + (int(late_time/100) % 100) / 60 + ((late_time % 100) / 360))
ax16.set_ylim(700,760)
ax16.set_xticks([])
ax16.set_yticks([])
ax16.plot(dtime16, dlv0rate16, lw=1, c='green')
ax16.set_title(TRR, fontsize=6)
lp_time_counter16, = ax16.plot([], [], lw=1, c='blue')
lp_TGF_0_16 = ax16.plot([TGF_fixed_time[0], TGF_fixed_time[0]],[700,760],lw=1, c='orange', alpha=.5)
lp_TGF_1_16 = ax16.plot([TGF_fixed_time[1], TGF_fixed_time[1]],[700,760],lw=1, c='orange', alpha=.5)
lp_TGF_2_16 = ax16.plot([TGF_fixed_time[2], TGF_fixed_time[2]],[700,760],lw=1, c='orange', alpha=.5)

ax17 = fig.add_subplot(gs2[2,0])
ax17.set_xlim(int(early_time/10000) + (int(early_time/100) % 100) / 60 + ((early_time % 100) / 360), int(late_time/10000) + (int(late_time/100) % 100) / 60 + ((late_time % 100) / 360))
ax17.set_ylim(700,760)
ax17.set_xticks([])
ax17.plot(dtime17, dlv0rate17, lw=1, c='green')
ax17.set_title(MLL, fontsize=6)
lp_time_counter17, = ax17.plot([], [], lw=1, c='blue')
lp_TGF_0_17 = ax17.plot([TGF_fixed_time[0], TGF_fixed_time[0]],[700,760],lw=1, c='orange', alpha=.5)
lp_TGF_1_17 = ax17.plot([TGF_fixed_time[1], TGF_fixed_time[1]],[700,760],lw=1, c='orange', alpha=.5)
lp_TGF_2_17 = ax17.plot([TGF_fixed_time[2], TGF_fixed_time[2]],[700,760],lw=1, c='orange', alpha=.5)

ax18 = fig.add_subplot(gs2[2,4])
ax18.set_xlim(int(early_time/10000) + (int(early_time/100) % 100) / 60 + ((early_time % 100) / 360), int(late_time/10000) + (int(late_time/100) % 100) / 60 + ((late_time % 100) / 360))
ax18.set_ylim(700,760)
ax18.set_xticks([])
ax18.set_yticks([])
ax18.plot(dtime18, dlv0rate18, lw=1, c='green')
ax18.set_title(MRR, fontsize=6)
lp_time_counter18, = ax18.plot([], [], lw=1, c='blue')
lp_TGF_0_18 = ax18.plot([TGF_fixed_time[0], TGF_fixed_time[0]],[700,760],lw=1, c='orange', alpha=.5)
lp_TGF_1_18 = ax18.plot([TGF_fixed_time[1], TGF_fixed_time[1]],[700,760],lw=1, c='orange', alpha=.5)
lp_TGF_2_18 = ax18.plot([TGF_fixed_time[2], TGF_fixed_time[2]],[700,760],lw=1, c='orange', alpha=.5)

ax19 = fig.add_subplot(gs2[3,0])
ax19.set_xlim(int(early_time/10000) + (int(early_time/100) % 100) / 60 + ((early_time % 100) / 360), int(late_time/10000) + (int(late_time/100) % 100) / 60 + ((late_time % 100) / 360))
ax19.set_ylim(700,760)
ax19.set_xticks([])
ax19.plot(dtime19, dlv0rate19, lw=1, c='green')
ax19.set_title(BLL, fontsize=6)
lp_time_counter19, = ax19.plot([], [], lw=1, c='blue')
lp_TGF_0_19 = ax19.plot([TGF_fixed_time[0], TGF_fixed_time[0]],[700,760],lw=1, c='orange', alpha=.5)
lp_TGF_1_19 = ax19.plot([TGF_fixed_time[1], TGF_fixed_time[1]],[700,760],lw=1, c='orange', alpha=.5)
lp_TGF_2_19 = ax19.plot([TGF_fixed_time[2], TGF_fixed_time[2]],[700,760],lw=1, c='orange', alpha=.5)

ax20 = fig.add_subplot(gs2[3,4])
ax20.set_xlim(int(early_time/10000) + (int(early_time/100) % 100) / 60 + ((early_time % 100) / 360), int(late_time/10000) + (int(late_time/100) % 100) / 60 + ((late_time % 100) / 360))
ax20.set_ylim(700,760)
ax20.set_xticks([])
ax20.set_yticks([])
ax20.plot(dtime20, dlv0rate20, lw=1, c='green')
ax20.set_title(BRR, fontsize=6)
lp_time_counter20, = ax20.plot([], [], lw=1, c='blue')
lp_TGF_0_20 = ax20.plot([TGF_fixed_time[0], TGF_fixed_time[0]],[700,760],lw=1, c='orange', alpha=.5)
lp_TGF_1_20 = ax20.plot([TGF_fixed_time[1], TGF_fixed_time[1]],[700,760],lw=1, c='orange', alpha=.5)
lp_TGF_2_20 = ax20.plot([TGF_fixed_time[2], TGF_fixed_time[2]],[700,760],lw=1, c='orange', alpha=.5)

ax21 = fig.add_subplot(gs2[4,0])
ax21.set_xlim(int(early_time/10000) + (int(early_time/100) % 100) / 60 + ((early_time % 100) / 360), int(late_time/10000) + (int(late_time/100) % 100) / 60 + ((late_time % 100) / 360))
ax21.set_ylim(700,760)

ax21.plot(dtime21, dlv0rate21, lw=1, c='green')
ax21.set_title(LLL, fontsize=6)
lp_time_counter21, = ax21.plot([], [], lw=1, c='blue')
lp_TGF_0_21 = ax21.plot([TGF_fixed_time[0], TGF_fixed_time[0]],[700,760],lw=1, c='orange', alpha=.5)
lp_TGF_1_21 = ax21.plot([TGF_fixed_time[1], TGF_fixed_time[1]],[700,760],lw=1, c='orange', alpha=.5)
lp_TGF_2_21 = ax21.plot([TGF_fixed_time[2], TGF_fixed_time[2]],[700,760],lw=1, c='orange', alpha=.5)

ax22 = fig.add_subplot(gs2[4,1])
ax22.set_xlim(int(early_time/10000) + (int(early_time/100) % 100) / 60 + ((early_time % 100) / 360), int(late_time/10000) + (int(late_time/100) % 100) / 60 + ((late_time % 100) / 360))
ax22.set_ylim(700,760)

ax22.set_yticks([])
ax22.plot(dtime22, dlv0rate22, lw=1, c='green')
ax22.set_title(LL, fontsize=6)
lp_time_counter22, = ax22.plot([], [], lw=1, c='blue')
lp_TGF_0_22 = ax22.plot([TGF_fixed_time[0], TGF_fixed_time[0]],[700,760],lw=1, c='orange', alpha=.5)
lp_TGF_1_22 = ax22.plot([TGF_fixed_time[1], TGF_fixed_time[1]],[700,760],lw=1, c='orange', alpha=.5)
lp_TGF_2_22 = ax22.plot([TGF_fixed_time[2], TGF_fixed_time[2]],[700,760],lw=1, c='orange', alpha=.5)

ax23 = fig.add_subplot(gs2[4,2])
ax23.set_xlim(int(early_time/10000) + (int(early_time/100) % 100) / 60 + ((early_time % 100) / 360), int(late_time/10000) + (int(late_time/100) % 100) / 60 + ((late_time % 100) / 360))
ax23.set_ylim(700,760)

ax23.set_yticks([])
ax23.plot(dtime23, dlv0rate23, lw=1, c='green')
ax23.set_title(LM, fontsize=6)
lp_time_counter23, = ax23.plot([], [], lw=1, c='blue')
lp_TGF_0_23 = ax23.plot([TGF_fixed_time[0], TGF_fixed_time[0]],[700,760],lw=1, c='orange', alpha=.5)
lp_TGF_1_23 = ax23.plot([TGF_fixed_time[1], TGF_fixed_time[1]],[700,760],lw=1, c='orange', alpha=.5)
lp_TGF_2_23 = ax23.plot([TGF_fixed_time[2], TGF_fixed_time[2]],[700,760],lw=1, c='orange', alpha=.5)

ax24 = fig.add_subplot(gs2[4,3])
ax24.set_xlim(int(early_time/10000) + (int(early_time/100) % 100) / 60 + ((early_time % 100) / 360), int(late_time/10000) + (int(late_time/100) % 100) / 60 + ((late_time % 100) / 360))
ax24.set_ylim(700,760)

ax24.set_yticks([])
ax24.plot(dtime24, dlv0rate24, lw=1, c='green')
ax24.set_title(LR, fontsize=6)
lp_time_counter24, = ax24.plot([], [], lw=1, c='blue')
lp_TGF_0_24 = ax24.plot([TGF_fixed_time[0], TGF_fixed_time[0]],[700,760],lw=1, c='orange', alpha=.5)
lp_TGF_1_24 = ax24.plot([TGF_fixed_time[1], TGF_fixed_time[1]],[700,760],lw=1, c='orange', alpha=.5)
lp_TGF_2_24 = ax24.plot([TGF_fixed_time[2], TGF_fixed_time[2]],[700,760],lw=1, c='orange', alpha=.5)

ax25 = fig.add_subplot(gs2[4,4])
ax25.set_xlim(int(early_time/10000) + (int(early_time/100) % 100) / 60 + ((early_time % 100) / 360), int(late_time/10000) + (int(late_time/100) % 100) / 60 + ((late_time % 100) / 360))
ax25.set_ylim(700,760)

ax25.set_yticks([])
ax25.plot(dtime25, dlv0rate25, lw=1, c='green')
ax25.set_title(LRR, fontsize=6)
lp_time_counter25, = ax25.plot([], [], lw=1, c='blue')
...
if (save == "y"):
    ...
    if all_day:
        anim.save("Movies/" + str(date) + ".mp4", fps=1, writer="ffmpeg", dpi=1000, bitrate=5000)
    else:
        anim.save("Movies/" + str(date) + "." + str(TGF_number + 1) + ".mp4", fps=1, writer="ffmpeg", dpi=1000, bitrate=5000)
